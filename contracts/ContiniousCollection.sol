...
contract ContiniousCollection is ERC721URIStorage, EIP712, AccessControl, Ownable {
    ...
    function withdraw() public {
        ...
        require(pendingWithdrawals[msg.sender] > 0, "Withdrawals balance should be greater than 0");
